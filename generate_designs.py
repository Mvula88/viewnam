...
<style>
  *{{margin:0;padding:0;box-sizing:border-box}}
  :root{{--green-deep:#0A4422;--green-mid:#1FA838;--green-bright:#38C853;--gold:#D4A843;--cream:#F5EFDE}}
  ...
  .anchor{{position:absolute;inset:0;background:linear-gradient(0deg,rgba(10,68,34,0.94) 0%,rgba(31,168,56,0.75) 18%,rgba(31,168,56,0.38) 32%,rgba(31,168,56,0) 46%),linear-gradient(125deg,rgba(31,168,56,0.94) 0%,rgba(31,168,56,0.80) 22%,rgba(31,168,56,0.45) 45%,rgba(31,168,56,0.12) 65%,rgba(31,168,56,0) 82%);z-index:3;pointer-events:none}}
  .shine{{position:absolute;inset:0;background:radial-gradient(ellipse 55% 45% at 22% 62%, rgba(56,200,83,0.42) 0%, rgba(56,200,83,0.18) 35%, rgba(56,200,83,0) 70%);z-index:4;pointer-events:none}}
...
DESIGNS = [
    ...
    dict(file='fb-01-shocking-stat.html', title='FB 01 — Seven in Ten',
         photo='inspection.jpg', pos='30% center',
    ...
    dict(file='fb-02-cost-math.html', title='FB 02 — Cost Math',
         photo='inspect 2.jpg', pos='center center',
         cat='The Real Math',
    ...
    dict(file='fb-03-red-flags.html', title='FB 03 — Red Flags',
         photo='inspect.jpg', pos='center center',
         cat='Red Flags',
    ...
    dict(file='fb-04-natis-codes.html', title='FB 04 — NaTIS Codes',
         photo='inspection 2.jpg', pos='center center',
         cat='The NaTIS Guide',
    ...
    dict(file='fb-05-how-it-works.html', title='FB 05 — How It Works',
         photo='inspection.jpg', pos='38% center',
         cat='The Process',
    ...
    dict(file='fb-06-what-we-check.html', title='FB 06 — What We Check',
         photo='inspection 1.jpg', pos='center center',
         cat='The Inspection',
    ...
    dict(file='fb-07-buyer-first.html', title='FB 07 — Buyer First',
         photo='thinking.jpg', pos='center center',
         cat='Who We Work For',
    ...
    dict(file='fb-11-seller-lies.html', title='FB 11 — Seller Lies',
         photo='think.jpg', pos='center center',
    ...
    dict(file='fb-22-inspectors.html', title='FB 22 — The Inspectors',
         photo='inspection.jpg', pos='62% center',
         cat='The People',
    ...
    dict(file='fb-23-no-commission.html', title='FB 23 — No Commission',
         photo='inspection.jpg', pos='center center',
         cat='Our Promise',
    ...
    dict(file='fb-31-thinking-of-buying.html', title='FB 31 — Thinking Of Buying',
         photo='thinking.jpg', pos='35% center',
