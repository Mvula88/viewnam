...
<style>
  *{{margin:0;padding:0;box-sizing:border-box}}
  :root{{--green-deep:#062A1F;--green-mid:#0B3D2C;--green-bright:#1C7A52;--gold:#D4A843;--cream:#F5EFDE}}
  ...
  .shine{{position:absolute;inset:0;background:radial-gradient(ellipse 55% 45% at 22% 62%, rgba(28,122,82,0.34) 0%, rgba(28,122,82,0.14) 35%, rgba(28,122,82,0) 70%);z-index:4;pointer-events:none}}
