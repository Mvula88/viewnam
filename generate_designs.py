...
<style>
  *{{margin:0;padding:0;box-sizing:border-box}}
  :root{{--green-deep:#062A1F;--green-mid:#0B3D2C;--gold:#D4A843;--cream:#F5EFDE}}
  ...
  .anchor{{position:absolute;inset:0;background:linear-gradient(0deg,rgba(6,42,31,0.92) 0%,rgba(11,61,44,0.72) 18%,rgba(11,61,44,0.34) 32%,rgba(11,61,44,0) 46%),linear-gradient(125deg,rgba(11,61,44,0.94) 0%,rgba(11,61,44,0.82) 22%,rgba(11,61,44,0.45) 45%,rgba(11,61,44,0.12) 65%,rgba(11,61,44,0) 82%);z-index:3;pointer-events:none}}
  .shine{{position:absolute;inset:0;background:radial-gradient(ellipse 55% 45% at 22% 62%, rgba(28,110,82,0.32) 0%, rgba(28,110,82,0.12) 35%, rgba(28,110,82,0) 70%);z-index:4;pointer-events:none}}
